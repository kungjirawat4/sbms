...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-zinc-50 via-amber-50 to-zinc-100 px-4 dark:from-zinc-950 dark:via-zinc-950 dark:to-black">
      {/* yellow/gray blobs */}
      <div className="pointer-events-none absolute -top-24 -left-24 h-80 w-80 rounded-full bg-amber-300/30 blur-3xl dark:bg-amber-400/10" />
      <div className="pointer-events-none absolute -bottom-24 -right-24 h-80 w-80 rounded-full bg-zinc-400/25 blur-3xl dark:bg-zinc-500/10" />
