...
const features = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M128 0C93.867 0 73.6 17.067 67.2 51.2c12.8-17.067 27.733-23.467 44.8-19.2 
           9.733 2.133 16.533 9.6 24 17.067 12.8 12.8 27.733 27.733 60.8 27.733 
           34.133 0 54.4-17.067 60.8-51.2-12.8 17.067-27.733 23.467-44.8 19.2 
           -9.733-2.133-16.533-9.6-24-17.067C176 14.933 161.067 0 128 0zm-60.8 
           76.8c-34.133 0-54.4 17.067-60.8 51.2 12.8-17.067 27.733-23.467 
           44.8-19.2 9.733 2.133 16.533 9.6 24 17.067 12.8 12.8 27.733 
           27.733 60.8 27.733 34.133 0 54.4-17.067 60.8-51.2-12.8 
           17.067-27.733 23.467-44.8 19.2-9.733-2.133-16.533-9.6-24-17.067
           -12.8-12.8-27.733-27.733-60.8-27.733z"
          fill="currentColor"
        />
      </svg>
    ),
  },
  {
    ...
    icon: (
      ...
      >
        {/* โล่เปล่า */}
        <path
          d="M32 4c6 4 12 6 20 7v20c0 12-8.5 21.4-20 25-11.5-3.6-20-13-20-25V11c8-.9 14-3 20-7z"
          fill="currentColor"
        />
      </svg>
    ),
...
export function CenterContent() {
  ...
  return (
    <>
      {/* ✅ fixed controls (อยู่นอก motion เพื่อไม่เด้งตอนรีเฟรช) */}
      <div className="fixed z-50 top-5 right-5">
        <LocaleSwitcher />
      </div>

      <div className="fixed z-50 top-5 right-16">
        <ThemeSwitch />
      </div>
      ...
      <motion.main
        ...
        className="relative flex min-h-dvh w-full  justify-center px-4"
      >
        ...
        <div className=" flex w-full max-w-3xl flex-col items-center justify-center gap-2 text-center md:pt-0">
          ...
          >
            <Link href="/dashboard">
              <Button className="h-11 rounded-xl bg-zinc-900 px-6 text-white hover:bg-zinc-800 dark:bg-amber-400 dark:text-black dark:hover:bg-amber-300">
                {t("getStarted")}
              </Button>
            </Link>
          </motion.div>
